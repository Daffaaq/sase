        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="categoryForm" action="{{ route('Kategori-Arsip-Surat-Masuk.store') }}" method="POST">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#categoryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('kategori-arsip-surat-masuk-list') }}',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        _token: '{{ csrf_token() }}'
            ...
            $('#categoryTable').on('click', '.editCategoryBtn', function() {
                ...
                var url = '{{ route('Kategori-Arsip-Surat-Masuk.edit', ':uuid') }}';
                url = url.replace(':uuid', uuid);

                $.get(url, function(response) {
                    var data = response.data;
                    $('#categoryModalLabel').text('Edit Kategori Arsip Surat Masuk');
                    var updateUrl = '{{ route('Kategori-Arsip-Surat-Masuk.update', ':uuid') }}';
            ...
            $('#confirmDeleteBtn').click(function() {
                var uuid = $(this).data('uuid');
                var url = '{{ route('Kategori-Arsip-Surat-Masuk.destroy', ':uuid') }}';
                url = url.replace(':uuid', uuid);
