        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="categoryForm" action="{{ route('Kategori-Surat-Masuk.store') }}" method="POST">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#categoryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('kategori-surat-masuk-list') }}',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        _token: '{{ csrf_token() }}'
            ...
            $('#categoryTable').on('click', '.editCategoryBtn', function() {
                ...
                var url = '{{ route('Kategori-Surat-Masuk.edit', ':uuid') }}';
                url = url.replace(':uuid', uuid);

                $.get(url, function(response) {
                    var data = response.data;
                    $('#categoryModalLabel').text('Edit Kategori Surat Masuk');
                    var updateUrl = '{{ route('Kategori-Surat-Masuk.update', ':uuid') }}';
            ...
            $('#confirmDeleteBtn').click(function() {
                var uuid = $(this).data('uuid');
                var url = '{{ route('Kategori-Surat-Masuk.destroy', ':uuid') }}';
                url = url.replace(':uuid', uuid);
