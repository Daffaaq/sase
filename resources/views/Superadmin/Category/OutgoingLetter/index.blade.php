        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="categoryForm" action="{{ route('Kategori-Surat-Keluar.store') }}" method="POST">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#categoryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('kategori-surat-keluar-list') }}',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        _token: '{{ csrf_token() }}'
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `
                                ...
                                <button data-uuid="${row.uuid}" data-name="${row.name_jenis_surat_keluar}" class="btn btn-xs btn-danger deleteCategoryBtn">
            ...
            $('#categoryTable').on('click', '.editCategoryBtn', function() {
                ...
                var url = '{{ route('Kategori-Surat-Keluar.edit', ':uuid') }}';
                url = url.replace(':uuid', uuid);

                $.get(url, function(response) {
                    var data = response.data;
                    $('#categoryModalLabel').text('Edit Kategori Surat Keluar');
                    var updateUrl = '{{ route('Kategori-Surat-Keluar.update', ':uuid') }}';
            ...
            $('#confirmDeleteBtn').click(function() {
                var uuid = $(this).data('uuid');
                var url = '{{ route('Kategori-Surat-Keluar.destroy', ':uuid') }}';
                url = url.replace(':uuid', uuid);
                $.ajax({
                    url: url,
                    type: 'DELETE',
