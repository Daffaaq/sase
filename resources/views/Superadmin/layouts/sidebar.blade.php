<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li
                class="nav-item {{ Request::routeIs('Kategori-Surat-Masuk.index', 'Kategori-Surat-Keluar.index', 'manajemen-letter-in-index') ? 'active' : '' }}">
                ...
                <div id="collapseTwo"
                    class="collapse {{ Request::routeIs('Kategori-Surat-Masuk.index', 'Kategori-Surat-Keluar.index', 'manajemen-letter-in-index') ? 'show' : '' }}"
