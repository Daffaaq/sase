        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="categoryForm" action="{{ route('Kategori-Arsip-Surat-Out-Kadiv.store') }}" method="POST">
                        @csrf
                        <div id="success-message" class="alert alert-success" style="display:none;">Data Berhasil Dikirim
                        </div>
                        <div id="error-message" class="alert alert-danger" style="display:none;"></div>
                        <div class="mb-3">
                            <label for="name_jenis_arsip_surat_keluar" class="form-label">Nama Kategori Arsip Surat
                                Keluar</label>
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#categoryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('kategori-arsip-surat-keluar-list-kadiv') }}',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        _token: '{{ csrf_token() }}'
            ...
            $('#categoryTable').on('click', '.editCategoryBtn', function() {
                ...
                var url = '{{ route('Kategori-Arsip-Surat-Out-Kadiv.edit', ':uuid') }}';
            ...
            $('#confirmDeleteBtn').click(function() {
                var uuid = $(this).data('uuid');
                var url = '{{ route('Kategori-Arsip-Surat-Out-Kadiv.destroy', ':uuid') }}';
                url = url.replace(':uuid', uuid);
